...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.BookSimpleAdapter;
...
public class BookListActivity extends Activity {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new BookSimpleAdapter(BookListActivity.this, list,
	        					R.layout.book_list_item,
	        					new String[] { "barcode","bookType","bookName","bookPhoto","publishDate" },
	        					new int[] { R.id.tv_barcode,R.id.tv_bookType,R.id.tv_bookName,R.id.iv_bookPhoto,R.id.tv_publishDate,},lv);
	...
	private OnCreateContextMenuListener bookListItemListener = new OnCreateContextMenuListener() {
		public void onCreateContextMenu(ContextMenu menu, View v,ContextMenuInfo menuInfo) {
			Declare declare = (Declare) BookListActivity.this.getApplication();
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < bookList.size(); i++) {
				...
				map.put("bookPhoto", HttpUtil.BASE_URL+ bookList.get(i).getBookPhoto());
				map.put("publishDate", bookList.get(i).getPublishDate());
				list.add(map);
			}
		} catch (Exception e) { 
