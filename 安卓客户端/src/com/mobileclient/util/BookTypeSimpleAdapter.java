...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  /*设置各个控件的展示内容*/
	  holder.tv_bookTypeId.setText("图书类别：" + mData.get(position).get("bookTypeId").toString());
	  holder.tv_bookTypeName.setText("类别名称：" + mData.get(position).get("bookTypeName").toString());
	  holder.tv_days.setText("可借阅天数：" + mData.get(position).get("days").toString());
	  /*返回修改好的view*/
	  return convertView; 
    } 
