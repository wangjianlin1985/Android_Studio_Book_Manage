...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.BookTypeSimpleAdapter;
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new BookTypeSimpleAdapter(BookTypeListActivity.this, list,
	        					R.layout.booktype_list_item,
	        					new String[] { "bookTypeId","bookTypeName","days" },
	        					new int[] { R.id.tv_bookTypeId,R.id.tv_bookTypeName,R.id.tv_days,},lv);
