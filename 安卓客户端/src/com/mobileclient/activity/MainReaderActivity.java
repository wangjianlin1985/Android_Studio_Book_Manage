...
public class MainReaderActivity extends MyTabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TabSpec firstSpec = tabHost.newTabSpec(FIRST_TAB).setIndicator(FIRST_TAB)
				.setContent(new Intent(this, BookListActivity.class));
		Button firstBtn = (Button)findViewById(R.id.firstBtn);
		firstBtn.setText("图书查询");
		/*第二tab页*/
		TabSpec secondSpec = tabHost.newTabSpec(SECOND_TAB).setIndicator(SECOND_TAB)
				.setContent(new Intent(this,LoanInfoReaderListActivity.class));
		Button secondBtn = (Button)findViewById(R.id.secondBtn);
		secondBtn.setText("我的借阅信息");
		/*第三tab页*/
		Intent intent = new Intent();
		intent.setClass(MainReaderActivity.this, ReaderSelfEditActivity.class);
		Bundle bundle = new Bundle();
		Declare declare = (Declare)MainReaderActivity.this.getApplication();
		bundle.putString("readerNo", declare.getUserName());
		intent.putExtras(bundle);
		TabSpec thirdSpec = tabHost.newTabSpec(THIRD_TAB).setIndicator(THIRD_TAB)
				.setContent(intent);
				//.setContent(new Intent(this,LoanInfoListActivity.class));
